...
{   
    ...
    public void RequestRewarded()
    {
        ...
        {
            //RequestRewardedAd(rewardedAd_ID1,1);
            //RequestRewardedAd(rewardedAd_ID2,2);
            //RequestRewardedAd(rewardedAd_ID3,3);
            //RequestRewardedAd(rewardedAd_ID1,4);
            //RequestRewardedAd(rewardedAd_ID2,5);
            //RequestRewardedAd(rewardedAd_ID3,6);
            //RequestRewardedAd(rewardedAd_ID1,7);
            //RequestRewardedAd(rewardedAd_ID2,8);
            //RequestRewardedAd(rewardedAd_ID3,9);
            //RequestRewardedAd(rewardedAd_ID1,10);
        ...
        else
        {
            ...
            //RequestRewardedAd(rewardedAd_ID1, 1);
            //RequestRewardedAd(rewardedAd_ID1, 2);
            //RequestRewardedAd(rewardedAd_ID1, 3);
            //RequestRewardedAd(rewardedAd_ID1, 4);
            //RequestRewardedAd(rewardedAd_ID1, 5);
            //RequestRewardedAd(rewardedAd_ID1, 6);
            //RequestRewardedAd(rewardedAd_ID1, 7);
            //RequestRewardedAd(rewardedAd_ID1, 8);
            //RequestRewardedAd(rewardedAd_ID1, 9);
            //RequestRewardedAd(rewardedAd_ID1, 10);
        }      
